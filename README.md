...
```text
package://github.com/2h2d-co/hk-config/releases/download/v0.11.0/hk-config@0.11.0
```
...
```pkl
amends "package://github.com/2h2d-co/hk-config/releases/download/v0.11.0/hk-config@0.11.0#/Config.pkl"

import "package://github.com/2h2d-co/hk-config/releases/download/v0.11.0/hk-config@0.11.0#/Base.pkl" as Base
import "package://github.com/2h2d-co/hk-config/releases/download/v0.11.0/hk-config@0.11.0#/Python.pkl" as Python
import "package://github.com/2h2d-co/hk-config/releases/download/v0.11.0/hk-config@0.11.0#/TypeScript.pkl" as TypeScript
import "package://github.com/2h2d-co/hk-config/releases/download/v0.11.0/hk-config@0.11.0#/Go.pkl" as Go
import "package://github.com/2h2d-co/hk-config/releases/download/v0.11.0/hk-config@0.11.0#/GitHubActions.pkl" as GitHubActions
import "package://github.com/2h2d-co/hk-config/releases/download/v0.11.0/hk-config@0.11.0#/Shell.pkl" as Shell
